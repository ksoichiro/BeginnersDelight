...
public class VillageConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Button(this.width / 2 - 155, buttonY, 100, 20,
                Component.translatable("config.beginnersdelight.reset"), b -> resetToDefaults()));
        this.addRenderableWidget(new Button(this.width / 2 - 50, buttonY, 100, 20,
                CommonComponents.GUI_CANCEL, b -> onClose()));
        this.doneButton = this.addRenderableWidget(new Button(this.width / 2 + 55, buttonY, 100, 20,
    ...
    static class NumberEntry extends Entry {
        ...
        public void render(PoseStack poseStack, int index, int top, int left, int width, int height,
            ...
            this.editBox.x = left + width - WIDGET_WIDTH;
            this.editBox.y = top;
    ...
    static class CycleEntry extends Entry {
        ...
        CycleEntry(Font font, Component label, boolean initialValue) {
            this.font = font;
            this.label = label;
