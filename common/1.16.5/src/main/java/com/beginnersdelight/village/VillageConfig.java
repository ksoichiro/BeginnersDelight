...
public class VillageConfig {
    ...
    public boolean set(String key, String value) {
        if ("plotSize".equals(key)) {
            plotSize = Integer.parseInt(value);
        } else if ("maxHeightDifference".equals(key)) {
            maxHeightDifference = Integer.parseInt(value);
        } else if ("generatePaths".equals(key)) {
            generatePaths = Boolean.parseBoolean(value);
        } else if ("respawnAtHouse".equals(key)) {
            respawnAtHouse = Boolean.parseBoolean(value);
        } else {
            return false;
        }
        save();
