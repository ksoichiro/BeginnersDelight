 ...
 * natural ground surface blocks with Grass Path blocks.
 */
public class VillagePathGenerator {
     ...
     * with Grass Path if it is a suitable block (natural ground, see
    ...
    private static int findPathSurface(ServerLevel level, int x, int z, int referenceY) {
        ...
        int minY = Math.max(0, referenceY - SURFACE_SEARCH_RANGE);
