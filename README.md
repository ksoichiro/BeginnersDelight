...
### For Players
- **Minecraft**: Java Edition 1.21.9, 1.21.8, 1.21.7, 1.21.6, 1.21.5, 1.21.4, 1.21.3, 1.21.1, 1.20.1, 1.19.2, 1.18.2, 1.17.1, or 1.16.5
...
- **Dependencies**:
  - Architectury API (18.0.5+ for 1.21.9, 17.0.8+ for 1.21.8, 17.0.8+ for 1.21.7, 17.0.6+ for 1.21.6, 16.1.4+ for 1.21.5, 15.0.1+ for 1.21.4, 14.0.4+ for 1.21.3, 13.0.8+ for 1.21.1, 9.2.14+ for 1.20.1, 6.6.92+ for 1.19.2, 4.12.94+ for 1.18.2, 2.10.12+ for 1.17.1, 1.32.68+ for 1.16.5)
...
**Output Files** (1.21.9):
- `fabric-1.21.9/build/libs/beginnersdelight-0.2.0-fabric.jar` - Fabric loader JAR
- `neoforge-1.21.9/build/libs/beginnersdelight-0.2.0-neoforge.jar` - NeoForge loader JAR
...
- **Structure Files**: NBT format, placed in `common-1.21.9/src/main/resources/data/beginnersdelight/structure/`
