 ...
 * version needs a client-side hook (the village config screen). Reunify with neoforge/base
 * once the screen is ported to the other NeoForge-supported versions.
 */
