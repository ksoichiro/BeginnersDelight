...
This document lists all third-party dependencies used in Beginner's Delight and their respective licenses.
...
- Runtime dependencies are not bundled with Beginner's Delight; users must install them separately
- NeoForge's LGPL-2.1 license does not affect Beginner's Delight's license due to linking exception
- Architectury API's LGPL-3.0 license does not affect Beginner's Delight's license due to linking exception

## License Compliance

Beginner's Delight is licensed under the LGPL-3.0-only License. All dependencies are compatible with this license:
